...
# define Rte_TypeDef_BswM_ModeDecl_ComFault_State
typedef uint8 BswM_ModeDecl_ComFault_State;

# define Rte_TypeDef_BswM_ModeDecl_ComFault_State_WithKL15
typedef uint8 BswM_ModeDecl_ComFault_State_WithKL15;
