...
static const Mcu_ClockCfgType Mcu_kClockConfiguration0[] =
{
    /*McuClockSettingConfig_0*/
  {
    ...
    {
      600U,  /* ramp up delay for K2 div step 1*/
      800U, /* ramp up delay for K2 div step 2*/
      800U, /* ramp up delay for K2 div step 3*/
      800U, /* ramp up delay for K2 div step 4*/
      800U, /* ramp up delay for K2 div step 5*/
      800U, /* ramp up delay for K2 div step 6*/
