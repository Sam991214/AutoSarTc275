...
if (exists(".text.OS_POSTTASKHOOK_CODE"))
{
  group OS_POSTTASKHOOK_CODE_GROUP(align=8)
  {
    select "[.]text.OS_POSTTASKHOOK_CODE";
  }
  "_OS_POSTTASKHOOK_CODE_START" = "_lc_gb_OS_POSTTASKHOOK_CODE_GROUP";
  "_OS_POSTTASKHOOK_CODE_END" = "_lc_ge_OS_POSTTASKHOOK_CODE_GROUP" - 1;
  "_OS_POSTTASKHOOK_CODE_LIMIT" = "_lc_ge_OS_POSTTASKHOOK_CODE_GROUP";
}
else
{
  "_OS_POSTTASKHOOK_CODE_START" = 0;
  "_OS_POSTTASKHOOK_CODE_END" = 0;
  "_OS_POSTTASKHOOK_CODE_LIMIT" = 0;
}
if (exists(".text.OS_PRETASKHOOK_CODE"))
{
  group OS_PRETASKHOOK_CODE_GROUP(align=8)
  {
    select "[.]text.OS_PRETASKHOOK_CODE";
  }
  "_OS_PRETASKHOOK_CODE_START" = "_lc_gb_OS_PRETASKHOOK_CODE_GROUP";
  "_OS_PRETASKHOOK_CODE_END" = "_lc_ge_OS_PRETASKHOOK_CODE_GROUP" - 1;
  "_OS_PRETASKHOOK_CODE_LIMIT" = "_lc_ge_OS_PRETASKHOOK_CODE_GROUP";
}
else
{
  "_OS_PRETASKHOOK_CODE_START" = 0;
  "_OS_PRETASKHOOK_CODE_END" = 0;
  "_OS_PRETASKHOOK_CODE_LIMIT" = 0;
}
