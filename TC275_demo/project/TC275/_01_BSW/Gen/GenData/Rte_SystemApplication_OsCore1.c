...
/**********************************************************************************************************************
 * Task:     OsTask_App10ms_Core1
 * Priority: 42
 * Schedule: NON
 *********************************************************************************************************************/
TASK(OsTask_App10ms_Core1) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_Unreachable */
{
  EventMaskType ev;

  for(;;)
  {
    (void)WaitEvent(Rte_Ev_RunS2_EcuM_EcuM_MainFunction); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)GetEvent(OsTask_App10ms_Core1, &ev); /* PRQA S 3417 */ /* MD_Rte_Os */
    (void)ClearEvent(ev & (Rte_Ev_RunS2_EcuM_EcuM_MainFunction)); /* PRQA S 3417 */ /* MD_Rte_Os */
