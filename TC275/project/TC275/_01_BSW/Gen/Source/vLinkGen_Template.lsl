...
section_layout mpe:vtc:linear
{
  ...
  group RegionBlock_0_DSPR_Core0(ordered, run_addr = 0x70000000)
  {
    ...
    "_OS_DATA_SHARED_VAR_ALL_START" = "_OS_DATA_SHARED_INIT_START";
    "_OS_DATA_SHARED_VAR_ALL_END" = "_OS_DATA_SHARED_INIT_END";
    "_OS_DATA_SHARED_VAR_ALL_LIMIT" = "_OS_DATA_SHARED_INIT_LIMIT";
    ...
    "_Data_Default_VAR_ALL_START" = "_Data_Default_INIT_START";
