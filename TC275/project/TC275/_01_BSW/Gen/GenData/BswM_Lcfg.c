 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: BswM_Lcfg.c
 *   Generation Time: 2024-11-05 16:53:52
...
/*lint -restore */
CONST(BswM_ActionListsType, BSWM_CONST) BswM_ActionLists[19] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
...
#include "BswM_vMemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
CONST(BswM_DeferredRulesType, BSWM_CONST) BswM_DeferredRules[8] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
    /* Index    RulesIdx        Referable Keys */
  { /*     0 */       3u },  /* [R_ESH_RunToPostRun] */
  { /*     1 */       4u },  /* [R_ESH_WaitToShutdown] */
  { /*     2 */       5u },  /* [R_ESH_WakeupToPrep] */
  { /*     3 */       6u },  /* [R_ESH_WaitToWakeup] */
  { /*     4 */       7u },  /* [R_ESH_WakeupToRun] */
...
CONST(BswM_GenericMappingType, BSWM_CONST) BswM_GenericMapping[2] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     1 */ BSWM_GENERIC_ESH_State              ,                                          2u,                                            1u, BSWM_GENERICVALUE_ESH_State_ESH_INIT                          }   /* [GENERIC_1, MRP_ESH_State] */
};
#define BSWM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "BswM_vMemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
CONST(BswM_ImmediateUserType, BSWM_CONST) BswM_ImmediateUser[2] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     1 */      0x03u,            11u,               3u }   /* [Name: ESH_State]                            */  /* [MRP_ESH_State, GENERIC_1] */
};
#define BSWM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "BswM_vMemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
#include "BswM_vMemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
CONST(BswM_RulesType, BSWM_CONST) BswM_Rules[14] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     3 */  8u,            3u, BswM_Rule_ESH_RunToPostRun           },  /* [R_ESH_RunToPostRun, MRP_ESH_State, MRP_ESH_ModeNotification, MRP_ESH_EcuMState, MRP_ESH_ComMIndication_CN_CAN00_5e566ad9, MRP_ESH_RunRequest_0, MRP_ESH_EcuMRequest_RUN, MRP_ESH_SelfRunRequestTimer] */
  { /*     4 */ 10u,            4u, BswM_Rule_ESH_WaitToShutdown         },  /* [R_ESH_WaitToShutdown, MRP_ESH_State, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests] */
  { /*     5 */ 12u,            5u, BswM_Rule_ESH_WakeupToPrep           },  /* [R_ESH_WakeupToPrep, MRP_ESH_State, MRP_ESH_EcuM_GetPendingWakeupEvents, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, MRP_ESH_ModeNotification] */
  { /*     6 */ 11u,            6u, BswM_Rule_ESH_WaitToWakeup           },  /* [R_ESH_WaitToWakeup, MRP_ESH_State, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests] */
  { /*     7 */ 13u,            7u, BswM_Rule_ESH_WakeupToRun            },  /* [R_ESH_WakeupToRun, MRP_ESH_State, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, MRP_ESH_ModeNotification] */
  { /*     8 */  3u,            8u, BswM_Rule_ESH_InitToWakeup           },  /* [R_ESH_InitToWakeup, MRP_ESH_State, MRP_ESH_EcuMState] */
  { /*     9 */  6u,            9u, BswM_Rule_ESH_PostRunToPrepNested    },  /* [R_ESH_PostRunToPrepNested] */
  { /*    10 */  5u,           10u, BswM_Rule_ESH_PostRunNested          },  /* [R_ESH_PostRunNested] */
  { /*    11 */  4u,           11u, BswM_Rule_ESH_PostRun                },  /* [R_ESH_PostRun, MRP_ESH_State, MRP_ESH_ModeNotification, MRP_ESH_EcuMState] */
  { /*    12 */  7u,           12u, BswM_Rule_ESH_PrepToWait             },  /* [R_ESH_PrepToWait, MRP_ESH_State, MRP_ESH_ModeNotification, MRP_ESH_EcuMState] */
  { /*    13 */  9u,           13u, BswM_Rule_ESH_RunToPostRunNested     }   /* [R_ESH_RunToPostRunNested] */
};
#define BSWM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "BswM_vMemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
VAR(BswM_RuleStatesUType, BSWM_VAR_NOINIT) BswM_RuleStates;  /* PRQA S 0759, 1514, 1533 */  /* MD_CSL_Union, MD_CSL_ObjectOnlyAccessedOnce, MD_CSL_ObjectOnlyAccessedOnce */
  ...
  /*     3 */  /* [R_ESH_RunToPostRun] */
  /*     4 */  /* [R_ESH_WaitToShutdown] */
  /*     5 */  /* [R_ESH_WakeupToPrep] */
  /*     6 */  /* [R_ESH_WaitToWakeup] */
  /*     7 */  /* [R_ESH_WakeupToRun] */
...
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_ESH_AL_RunToPostRun(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx)
{
  ...
  (void)EcuM_SetState(ECUM_STATE_APP_POST_RUN);
...
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_ESH_AL_WakeupToPrep(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx)
{
  ...
  (void)EcuM_SetState(ECUM_STATE_SHUTDOWN);
...
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_ESH_AL_WakeupToRun(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx)
{
  ...
  BswM_UpdateTimer(partitionIdx, BSWM_TMR_ESH_SelfRunRequestTimer, 20uL);
  (void)ComM_RequestComMode(ComMConf_ComMUser_ComMUser, COMM_FULL_COMMUNICATION);
  BswM_ESH_OnEnterRun();
  (void)EcuM_SetState(ECUM_STATE_APP_RUN);
...
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_ESH_RunToPostRun(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx)
{
  ...
  if(((BswM_GetGenericState(1, 0u) == BSWM_GENERICVALUE_ESH_State_ESH_RUN) && (BswM_Mode_Notification_ESH_ModeNotification_BswM_MDGP_ESH_Mode == RTE_MODE_ESH_Mode_RUN) && (BswM_GetEcuMModeState(0u) == ECUM_STATE_APP_RUN)) && ((BswM_GetComMChannelState(0, 0u) == COMM_NO_COMMUNICATION) && (Request_ESH_RunRequest_0_requestedMode == RELEASED) && (BswM_GetEcuMRunRequestState(1, 0u) == ECUM_RUNSTATUS_RELEASED) && (BswM_GetTimerState(0, 0u) == BSWM_TIMER_EXPIRED)))
  {
...
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_ESH_InitToWakeup(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx)
{
  ...
  if((BswM_GetGenericState(1, 0u) == BSWM_GENERICVALUE_ESH_State_ESH_INIT) && (BswM_GetEcuMModeState(0u) == ECUM_STATE_STARTUP))
  {
...
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_ESH_PostRunToPrepNested(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx)
{
  ...
  if((Request_ESH_PostRunRequest_0_requestedMode == RELEASED) && (BswM_GetEcuMRunRequestState(0, 0u) == ECUM_RUNSTATUS_RELEASED))
  {
...
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_ESH_PostRunNested(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx)
{
  ...
  if((Request_ESH_RunRequest_0_requestedMode == REQUESTED) || (BswM_GetEcuMRunRequestState(1, 0u) == ECUM_RUNSTATUS_REQUESTED) || ((EcuM_GetValidatedWakeupEvents() != 0u) || (BswM_GetGenericState(0, 0u) == BSWM_GENERICVALUE_ESH_ComMPendingRequests_ESH_COMM_PENDING_REQUEST)))
  {
...
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_ESH_PostRun(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx)
{
  ...
  if((BswM_GetGenericState(1, 0u) == BSWM_GENERICVALUE_ESH_State_ESH_POST_RUN) && (BswM_Mode_Notification_ESH_ModeNotification_BswM_MDGP_ESH_Mode == RTE_MODE_ESH_Mode_POSTRUN) && (BswM_GetEcuMModeState(0u) == ECUM_STATE_APP_POST_RUN))
  {
...
{
  BswM_HandleType retVal = BSWM_NO_ACTIONLIST(partitionIdx);
  /* Evaluate logical expression ESH_LE_PrepShutdownToWaitForNvM. */ /* PRQA S 3415 1 */ /* MD_BSWM_3415 */
  if((BswM_GetGenericState(1, 0u) == BSWM_GENERICVALUE_ESH_State_ESH_PREP_SHUTDOWN) && (BswM_Mode_Notification_ESH_ModeNotification_BswM_MDGP_ESH_Mode == RTE_MODE_ESH_Mode_SHUTDOWN) && ((BswM_GetEcuMModeState(0u) == ECUM_STATE_SHUTDOWN) || (BswM_GetEcuMModeState(0u) == ECUM_STATE_SLEEP)))
  {
