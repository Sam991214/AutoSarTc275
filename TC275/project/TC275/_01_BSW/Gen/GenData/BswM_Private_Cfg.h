 ...
 *   Generation Time: 2024-10-19 16:02:14
...
#define BSWM_ID_RULE_ESH_WaitToShutdown         4u 
#define BSWM_ID_RULE_ESH_WakeupToPrep           5u 
#define BSWM_ID_RULE_ESH_WaitToWakeup           6u 
#define BSWM_ID_RULE_ESH_WakeupToRun            7u 
#define BSWM_ID_RULE_ESH_InitToWakeup           8u 
#define BSWM_ID_RULE_ESH_PostRunToPrepNested    9u 
#define BSWM_ID_RULE_ESH_PostRunNested          10u 
#define BSWM_ID_RULE_ESH_PostRun                11u 
#define BSWM_ID_RULE_ESH_PrepToWait             12u 
...
#define BswM_GetSizeOfActionListsOfPCPartitionConfig(partitionIndex)                                19u  /**< the number of accomplishable value elements in BswM_ActionLists */
...
#define BswM_GetSizeOfRuleStatesOfPCPartitionConfig(partitionIndex)                                 14u  /**< the number of accomplishable value elements in BswM_RuleStates */
...
#define BswM_GetSizeOfRulesOfPCPartitionConfig(partitionIndex)                                      14u  /**< the number of accomplishable value elements in BswM_Rules */
...
#define BswM_GetExternalIdOfComMChannelMapping(Index, partitionIndex)                               ComMConf_ComMChannel_CN_CAN00_5e566ad9  /**< External id of BswMComMIndication. */
