 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: EcuM_Cfg.h
 *   Generation Time: 2024-10-19 14:09:24
...
#define ECUM_BSWMCURRENTMODULESTATE                                   STD_ON
#define ECUM_BSWMREQUESTEDMODULESTATE                                 STD_ON
...
#define ECUM_USERTABLE                                                STD_OFF  /**< Deactivateable: 'EcuM_UserTable' Reason: 'the array is deactivated because the size is 0 in all variants and the piece of data is in the configuration class: PRE_COMPILE' */
...
#define ECUM_BSWMCURRENTMODULESTATEOFPCCONFIG                         STD_ON
#define ECUM_BSWMREQUESTEDMODULESTATEOFPCCONFIG                       STD_ON
...
#define ECUM_ISDEF_BSWMCURRENTMODULESTATEOFPCCONFIG                   STD_ON
#define ECUM_ISDEF_BSWMREQUESTEDMODULESTATEOFPCCONFIG                 STD_ON
...
#define ECUM_EQ2_BSWMCURRENTMODULESTATEOFPCCONFIG                     (&(EcuM_BswMCurrentModuleState))
#define ECUM_EQ2_BSWMREQUESTEDMODULESTATEOFPCCONFIG                   (&(EcuM_BswMRequestedModuleState))
...
/** 
  ...
  \{
*/ 
/**   \brief  type used to point to EcuM_BswMCurrentModuleState */
typedef P2VAR(EcuM_StateType, TYPEDEF, ECUM_VAR_NOINIT) EcuM_BswMCurrentModuleStatePtrType;

/**   \brief  type used to point to EcuM_BswMRequestedModuleState */
typedef P2VAR(EcuM_StateType, TYPEDEF, ECUM_VAR_NOINIT) EcuM_BswMRequestedModuleStatePtrType;
...
typedef P2VAR(EcuM_PostRunRequestCounterType, TYPEDEF, ECUM_VAR_NOINIT) EcuM_PostRunRequestCounterPtrType;

/**   \brief  type used to point to EcuM_RunRequestCounter */
typedef P2VAR(EcuM_RunRequestCounterType, TYPEDEF, ECUM_VAR_NOINIT) EcuM_RunRequestCounterPtrType;
