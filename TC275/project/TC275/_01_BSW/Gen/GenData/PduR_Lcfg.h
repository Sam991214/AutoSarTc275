...
#define PDUR_INVALIDHNDOFAPPLICATIONID2DESTAPPLICATIONMANAGERROM                                    STD_OFF  /**< Deactivateable: 'PduR_ApplicationId2DestApplicationManagerRom.InvalidHnd' Reason: 'the array is deactivated because the size is 0 and the piece of data is in the configuration class: PRE_COMPILE' */
...
#define PDUR_SRCAPPLICATIONROMENDIDXOFDESTAPPLICATIONMANAGERROM                                     STD_OFF  /**< Deactivateable: 'PduR_DestApplicationManagerRom.SrcApplicationRomEndIdx' Reason: 'All indirection targets are deactivated in all variants.' */
#define PDUR_SRCAPPLICATIONROMSTARTIDXOFDESTAPPLICATIONMANAGERROM                                   STD_OFF  /**< Deactivateable: 'PduR_DestApplicationManagerRom.SrcApplicationRomStartIdx' Reason: 'All indirection targets are deactivated in all variants.' */
...
#define PDUR_SRCAPPLICATIONROM                                                                      STD_OFF  /**< Deactivateable: 'PduR_SrcApplicationRom' Reason: 'the struct is deactivated because all elements are deactivated.' */
...
#define PDUR_DESTAPPLICATIONMANAGERROMOFPCCONFIG                                                    STD_ON
...
#define PDUR_SIZEOFDESTAPPLICATIONMANAGERROMOFPCCONFIG                                              STD_ON
...
#define PDUR_ISDEF_DESTAPPLICATIONMANAGERROMOFPCCONFIG                                              STD_ON
...
#define PDUR_EQ2_DESTAPPLICATIONMANAGERROMOFPCCONFIG                                                PduR_DestApplicationManagerRom
...
#define PduR_GetDestApplicationManagerRomOfPCConfig()                                               PduR_DestApplicationManagerRom  /**< the pointer to PduR_DestApplicationManagerRom */
...
#define PduR_GetSizeOfDestApplicationManagerRomOfPCConfig()                                         1u  /**< the number of accomplishable value elements in PduR_DestApplicationManagerRom */
...
#define PduR_GetSizeOfRmDestRomOfPCConfig()                                                         8u  /**< the number of accomplishable value elements in PduR_RmDestRom */
#define PduR_GetSizeOfRmGDestRomOfPCConfig()                                                        8u  /**< the number of accomplishable value elements in PduR_RmGDestRom */
#define PduR_GetSizeOfRmSrcRomOfPCConfig()                                                          8u  /**< the number of accomplishable value elements in PduR_RmSrcRom */
#define PduR_GetSizeOfRmTransmitFctPtrOfPCConfig()                                                  1u  /**< the number of accomplishable value elements in PduR_RmTransmitFctPtr */
#define PduR_GetSizeOfRxIf2DestOfPCConfig()                                                         3u  /**< the number of accomplishable value elements in PduR_RxIf2Dest */
#define PduR_GetSizeOfTx2LoOfPCConfig()                                                             5u  /**< the number of accomplishable value elements in PduR_Tx2Lo */
...
#define PduR_GetDestApplicationManagerRomIdxOfMmRom(Index)                                          (PduR_GetMmRomOfPCConfig()[(Index)].DestApplicationManagerRomIdxOfMmRom)
...
#define PduR_GetRmSrcRomIdxOfTx2Lo(Index)                                                           ((PduR_RmSrcRomIdxOfTx2LoType)((((PduR_RmSrcRomIdxOfTx2LoType)(Index)) + 3u)))  /**< the index of the 0:1 relation pointing to PduR_RmSrcRom */
...
#define PduR_HasDestApplicationManagerRomOfPCConfig()                                               (TRUE != FALSE)
...
#define PduR_HasSizeOfDestApplicationManagerRomOfPCConfig()                                         (TRUE != FALSE)
