...
# define Rte_Ev_Cyclic2_OsTask_Bsw5ms_Core0_0_10ms     ((EventMaskType)1uLL)
# define Rte_Ev_Cyclic2_OsTask_Bsw5ms_Core0_0_20ms     ((EventMaskType)2uLL)
# define Rte_Ev_Cyclic2_OsTask_Bsw5ms_Core0_0_5ms     ((EventMaskType)4uLL)
# define Rte_Ev_RunS2_EcuM_EcuM_MainFunction     ((EventMaskType)1uLL)
# define Rte_Ev_Run_lock_lock     ((EventMaskType)8uLL)
