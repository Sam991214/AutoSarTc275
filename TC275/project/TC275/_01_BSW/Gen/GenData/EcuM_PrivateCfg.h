...
/** 
  ...
  \{
*/ 
#define EcuM_GetBswMCurrentModuleStateOfPCConfig()                    (&(EcuM_BswMCurrentModuleState))  /**< the pointer to EcuM_BswMCurrentModuleState */
#define EcuM_GetBswMRequestedModuleStateOfPCConfig()                  (&(EcuM_BswMRequestedModuleState))  /**< the pointer to EcuM_BswMRequestedModuleState */
...
#define EcuM_GetEcuM_CRCHash_LowerOfPCConfig()                        0x87C94402u
#define EcuM_GetEcuM_CRCHash_UpperOfPCConfig()                        0x35E3C897u
...
/** 
  ...
  \{
*/ 
#define EcuM_GetBswMCurrentModuleState()                              ((*(EcuM_GetBswMCurrentModuleStateOfPCConfig())))
#define EcuM_GetBswMRequestedModuleState()                            ((*(EcuM_GetBswMRequestedModuleStateOfPCConfig())))
...
/** 
  ...
  \{
*/ 
#define EcuM_SetBswMCurrentModuleState(Value)                         (*(EcuM_GetBswMCurrentModuleStateOfPCConfig())) = (Value)
#define EcuM_SetBswMRequestedModuleState(Value)                       (*(EcuM_GetBswMRequestedModuleStateOfPCConfig())) = (Value)
...
/** 
  ...
  \{
*/ 
#define EcuM_HasBswMCurrentModuleState()                              (TRUE != FALSE)
#define EcuM_HasBswMRequestedModuleState()                            (TRUE != FALSE)
...
#define EcuM_HasBswMCurrentModuleStateOfPCConfig()                    (TRUE != FALSE)
#define EcuM_HasBswMRequestedModuleStateOfPCConfig()                  (TRUE != FALSE)
...
/** 
  ...
  \{
*/ 
#define EcuM_IncBswMCurrentModuleState()                              EcuM_GetBswMCurrentModuleState()++
#define EcuM_IncBswMRequestedModuleState()                            EcuM_GetBswMRequestedModuleState()++
...
/** 
  ...
  \{
*/ 
#define EcuM_DecBswMCurrentModuleState()                              EcuM_GetBswMCurrentModuleState()--
#define EcuM_DecBswMRequestedModuleState()                            EcuM_GetBswMRequestedModuleState()--
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern CONST(EcuM_PartitionDataType, ECUM_CONST) EcuM_PartitionData[3];
#define ECUM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(EcuM_StateType, ECUM_VAR_NOINIT) EcuM_BswMCurrentModuleState;
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(EcuM_StateType, ECUM_VAR_NOINIT) EcuM_BswMRequestedModuleState;
#define ECUM_STOP_SEC_VAR_NOINIT_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(EcuM_PostRunRequestCounterType, ECUM_VAR_NOINIT) EcuM_PostRunRequestCounter;
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
extern VAR(EcuM_RunRequestCounterType, ECUM_VAR_NOINIT) EcuM_RunRequestCounter;
#define ECUM_STOP_SEC_VAR_NOINIT_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
